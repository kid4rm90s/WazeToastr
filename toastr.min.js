!(function (e) {
  e(['jquery'], function (e) {
    return (function () {
      ...
      function u(e, t, n) {
        return console.groupCollapsed('%c' + t, 'background: #252525; color: #e94f64'), console.log(e), console.groupEnd(), C({ type: x.debug, iconClass: h().iconClasses.debug, message: e, optionsOverride: n, title: t });
      }
      function d(t) {
        var o = h();
      ...
      function g() {
        return {
          tapToDismiss: !0,
          toastClass: 'toast-wazetoastr',
          containerId: 'toast-container-wazetoastr',
          containerClass: 'toast-container-wazetoastr',
          debug: !1,
          showMethod: 'fadeIn',
          showDuration: 300,
          showEasing: 'swing',
      ...
      function C(t) {
        ...
        function c() {
          q.hide(),
            ...
            B.timeOut > 0 && ((M = setTimeout(D, B.timeOut)), (N.maxHideTime = parseFloat(B.timeOut)), (N.hideEta = new Date().getTime() + N.maxHideTime), B.progressBar && (N.intervalId = setInterval(E, 10)));
        }
        function l() {
  ...
  'function' == typeof define && define.amd
    ? define
    : function (e, t) {
        'undefined' != typeof module && module.exports ? (module.exports = t(require('jquery'))) : (window.wazetoastr = t(window.jQuery));
      }
);
